...
jest.mock('../../../../src/main/models/adapters/tts/tts_cartesia', () => ({
	createCartesiaSpeechAdapter: mk('c'),
}));
jest.mock('../../../../src/main/models/adapters/tts/tts_deepgram', () => ({
	createDeepgramSpeechAdapter: mk('d'),
}));
jest.mock('../../../../src/main/models/adapters/tts/tts_elevenlabs', () => ({
	createElevenLabsSpeechAdapter: elevenlabs,
}));
jest.mock('../../../../src/main/models/adapters/tts/tts_google', () => ({
	createGoogleSpeechAdapter: mk('g'),
}));
jest.mock('../../../../src/main/models/adapters/tts/tts_minimax', () => ({
	createMiniMaxSpeechAdapter: mk('mm'),
}));
jest.mock('../../../../src/main/models/adapters/tts/tts_mistral', () => ({
	createMistralSpeechAdapter: mk('mi'),
}));
jest.mock('../../../../src/main/models/adapters/tts/tts_openai', () => ({
	createOpenAISpeechAdapter: mk('o'),
}));
