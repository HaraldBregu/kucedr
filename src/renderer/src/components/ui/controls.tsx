...
export function PromptInputControls({
	...
	return (
		<div data-slot="prompt-input-controls" className="flex min-h-6 w-full items-center justify-between pt-1">
			<div data-slot="prompt-input-control-buttons" className="inline-flex items-center gap-0.5 px-3">
				{leadingAction}
				{content}
			</div>
			{isLoading ? (
