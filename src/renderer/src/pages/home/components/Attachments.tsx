		...
		<>
			{images.length > 0 ? (
				<AttachmentGroup
					...
					className="grid w-[min(16rem,100%)] grid-cols-2 gap-2 overflow-x-visible! sm:grid-cols-3"
				>
					{images.map((attachment, index) => (
						<Attachment
							...
							size="sm"
							className="w-full min-w-0 overflow-hidden rounded-[16px] border-0 has-data-[slot=attachment-media]:p-0"
						>
