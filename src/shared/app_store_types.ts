export type AppStoreValue =
	null | boolean | number | string | AppStoreValue[] | { [key: string]: AppStoreValue };

export interface AppStorageApi {
	getAppStoreValue<T extends AppStoreValue = AppStoreValue>(key: string): Promise<T | undefined>;
