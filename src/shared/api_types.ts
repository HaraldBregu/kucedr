...
export interface AgentApi {
	...
	archiveWorkspaceEntry: (entryPath: string, action: 'compress' | 'extract') => Promise<string>;
...
export interface ProviderApi {
	...
	remove: (id: string, kind: Exclude<ProviderCredentialKind, 'search_engines'>) => Promise<void>;
	...
	setPluginEnabled: (
		...
		id: string,
		enabled: boolean
	) => Promise<EnabledPluginProviders>;
...
export interface AppsApi {
	...
	selectDebugPath: () => Promise<string | undefined>;
}
