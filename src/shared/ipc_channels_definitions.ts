...
export const CodingChannels = {
	...
	getSession: 'coding:sessions:get',
	renameSession: 'coding:sessions:rename',
	deleteSession: 'coding:sessions:delete',
	send: 'coding:send',
	response: 'coding:response',
	cancel: 'coding:cancel',
	connectCodex: 'coding:codex:connect',
	cancelCodexLogin: 'coding:codex:connect:cancel',
	disconnectCodex: 'coding:codex:disconnect',
	authEvent: 'coding:auth:event',
} as const;
...
export const AppChannels = {
	...
	setTrayClickAction: 'app:set-tray-click-action',
	getTrayClickAction: 'app:get-tray-click-action',
