...
export interface AppInvokeChannelMap {
	...
	[AppChannels.storages]: {
		args: [];
		result: import('./provider_types').CatalogStorage[];
	};
...
export interface AppsInvokeChannelMap {
	...
	[AppsChannels.selectDebugPath]: { args: []; result: string | undefined };
}
...
export interface MemoryInvokeChannelMap {
	...
	[MemoryChannels.forget]: { args: [match: string]; result: { removed: number } };
