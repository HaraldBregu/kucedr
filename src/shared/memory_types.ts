...
export interface MemoryEntry { id: string; fact: string }
export interface MemoryStatus { running: boolean; lastSuccess: string | null; error: string | null; pending: number }
