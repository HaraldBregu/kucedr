import type { CodingSettings, CodingResponseEvent, CodingCatalog, CodingAuthEvent, CodingAuthStatus, CoderInteraction, CoderInteractionResponse } from '../../../shared/coding_types';
