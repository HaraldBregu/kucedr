...
const darkThemeColors: AppThemeColors = {
	...lightThemeColors,
	'app-window-background-base': '#121010',
	'app-surface-background-base': '#1c1717',
	'app-popover-background-base': '#1c1717',
	'app-sidebar-background-base': '#1c1717',
	'app-window-background':
		'color-mix(in srgb, var(--app-window-background-base) calc(var(--app-bg-opacity) * 100%), transparent)',
	'app-surface-background':
		'color-mix(in srgb, var(--app-surface-background-base) calc(var(--app-surface-opacity) * 100%), transparent)',
	...
	'primary': '#ffb86b',
	'primary-foreground': '#121010',
	'secondary': '#3a2a2a',
	'secondary-foreground': 'var(--foreground)',
	'muted': '#3a2a2a',
	'muted-foreground': 'color-mix(in srgb, var(--foreground) 65%, var(--app-window-background-base))',
	'accent': '#ff7a7a',
	'accent-foreground': '#121010',
	...
	'link': 'var(--accent)',
	'link-on-primary': 'var(--primary-foreground)',
	'command': 'var(--primary)',
};
