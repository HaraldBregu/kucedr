...
const lightThemeColors: AppThemeColors = {
	...
	'app-window-background-base': 'oklch(0.9195 0.0169 88.0030)',
	'app-surface-background-base': 'oklch(0.9530 0.0156 86.4257)',
	'app-popover-background-base': 'oklch(0.9530 0.0156 86.4257)',
	'app-sidebar-background-base': 'oklch(0.8985 0.0199 87.5195)',
...
const darkThemeColors: AppThemeColors = {
	...
	'code-highlight': 'oklch(0.371 0 0)',
	'code-number': 'oklch(0.708 0 0)',
	selection: 'oklch(0.922 0 0)',
	'selection-foreground': 'oklch(0.205 0 0)',
	link: 'oklch(0.708 0 0)',
