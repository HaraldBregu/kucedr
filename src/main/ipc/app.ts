...
const darkThemeColors: AppThemeColors = {
	...lightThemeColors,
	'app-window-background-base': 'oklch(0.21 0.01 260)',
	'app-surface-background-base': 'oklch(0.29 0.01 260)',
	'app-popover-background-base': 'oklch(0.29 0.01 260)',
	'app-sidebar-background-base': 'oklch(0.26 0.01 260)',
	'app-window-background':
	...
	'primary-foreground': 'oklch(0.24 0.01 260)',
	secondary: 'oklch(0.32 0.01 260)',
	'secondary-foreground': 'oklch(0.985 0 0)',
	muted: 'oklch(0.30 0.01 260)',
	'muted-foreground': 'oklch(0.708 0 0)',
	accent: 'oklch(0.40 0.02 260)',
	'accent-foreground': 'oklch(0.985 0 0)',
	destructive: 'oklch(0.704 0.191 22.216)',
	'destructive-foreground': 'oklch(0.58 0.22 27)',
	border: 'oklch(1 0 0 / 14%)',
	input: 'oklch(1 0 0 / 20%)',
	ring: 'oklch(0.62 0.02 260)',
	...
	'surface-foreground': 'oklch(0.76 0 0)',
	'code-highlight': 'oklch(0.34 0.01 260)',
	'code-number': 'oklch(0.72 0 0)',
	selection: 'oklch(0.922 0 0)',
	'selection-foreground': 'oklch(0.24 0.01 260)',
