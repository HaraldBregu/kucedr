...
const lightThemeColors: AppThemeColors = {
	...
	'app-window-background-base': 'oklch(1 0 0)',
	'app-surface-background-base': 'oklch(1 0 0)',
	'app-popover-background-base': 'oklch(1 0 0)',
	'app-sidebar-background-base': 'oklch(0.9846 0.0017 247.8389)',
	...
	'code-number': 'oklch(0.551 0.0234 264.3637)',
	selection: 'oklch(0.7686 0.1647 70.0804)',
	'selection-foreground': 'oklch(0 0 0)',
	link: 'oklch(0.4732 0.1247 46.2007)',
...
const darkThemeColors: AppThemeColors = {
	...lightThemeColors,
	'app-window-background-base': 'oklch(0.2046 0 0)',
	'app-surface-background-base': 'oklch(0.2686 0 0)',
	'app-popover-background-base': 'oklch(0.2686 0 0)',
	'app-sidebar-background-base': 'oklch(0.1684 0 0)',
	'app-window-background':
	...
	selection: 'oklch(0.7686 0.1647 70.0804)',
	'selection-foreground': 'oklch(0 0 0)',
	link: 'oklch(0.7686 0.1647 70.0804)',
	...
	register(
		...
		ipcMain.handle(
			...
			wrapSimpleHandler(() => {
				...
				try {
					const systemStatus = systemPreferences.getMediaAccessStatus('screen');
					return {
						systemStatus,
						requiresRelaunch: systemStatus === 'granted',
					};
				} catch {
					return { systemStatus: 'unknown', requiresRelaunch: false };
				}
